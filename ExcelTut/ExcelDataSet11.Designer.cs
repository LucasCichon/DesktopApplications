...
namespace ExcelTut {
    ...
    public partial class ExcelDataSet1 : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/ExcelDataSet11.xsd";
        ...
        public partial class CustomersDataTable : global::System.Data.TypedTableBase<CustomersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public CustomersRow AddCustomersRow(string CustomerID, string FirstName, string LastName, string Age) {
...
namespace ExcelTut.ExcelDataSet1TableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Customers] WHERE (([CustomerID] = @Original_CustomerID) AND ([" +
                "FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName) AND ([Ag" +
                "e] = @Original_Age))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Customers] ([CustomerID], [FirstName], [LastName], [Age]) VALU" +
                "ES (@CustomerID, @FirstName, @LastName, @Age);\r\nSELECT CustomerID, FirstName, La" +
                "stName, Age FROM Customers WHERE (CustomerID = @CustomerID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customers] SET [CustomerID] = @CustomerID, [FirstName] = @FirstName, [LastName] = @LastName, [Age] = @Age WHERE (([CustomerID] = @Original_CustomerID) AND ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName) AND ([Age] = @Original_Age));
SELECT CustomerID, FirstName, LastName, Age FROM Customers WHERE (CustomerID = @CustomerID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ExcelTut.Properties.Settings.Default.ExcelConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CustomerID, FirstName, LastName, Age FROM dbo.Customers";
        ...
        public virtual int Fill(ExcelDataSet1.CustomersDataTable dataTable) {
        ...
        public virtual ExcelDataSet1.CustomersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ExcelDataSet1.CustomersDataTable dataTable = new ExcelDataSet1.CustomersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ExcelDataSet1.CustomersDataTable dataTable) {
        ...
        public virtual int Delete(string Original_CustomerID, string Original_FirstName, string Original_LastName, string Original_Age) {
        ...
        public virtual int Insert(string CustomerID, string FirstName, string LastName, string Age) {
            if ((CustomerID == null)) {
        ...
        public virtual int Update(string CustomerID, string FirstName, string LastName, string Age, string Original_CustomerID, string Original_FirstName, string Original_LastName, string Original_Age) {
            if ((CustomerID == null)) {
                throw new global::System.ArgumentNullException("CustomerID");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string Age, string Original_CustomerID, string Original_FirstName, string Original_LastName, string Original_Age) {
            return this.Update(Original_CustomerID, FirstName, LastName, Age, Original_CustomerID, Original_FirstName, Original_LastName, Original_Age);
        }
    }
